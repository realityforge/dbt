...
== Remove Transactional Migration Support

Not sure if any of the dependencies rely on this. If so it should be copied to
...
== Add add_database_name_filter(/@@MASTER@@/, "master")